    ...
    models: {
      ...
      merchants: {
        ...
        details: {
          ...
          pricing: {
            perMillion: '{{currency}} / 1M tokens',
            perRequest: '{{currency}} / request',
            groups: {
              ...
              fastMode: 'Fast mode',
              fastModeUntil: 'Fast mode (up to {{maximum}} tokens)',
              fastModeTier: 'Fast mode (over {{minimum}} tokens)',
              fastModeRange: 'Fast mode (over {{minimum}} and up to {{maximum}} tokens)',
    ...
    account: {
      ...
      sections: {
        admin: {
          ...
          merchantResources: {
            eyebrow: 'MERCHANT RESOURCES',
            back: 'Back to merchants',
            navigation: 'Merchant resource navigation',
            actions: {
              column: 'Actions',
              channel: {
            ...
            feedback: {
              channel: {
                active: 'The channel is active again.',
                offline: 'The channel was forced offline.',
              },
              model: {
                offline: 'The model listing was unpublished.',
                published: 'The model listing was restored.',
              },
              statusFailed: 'The status could not be updated. Refresh and try again.',
            },
            confirm: {
              cancel: 'Cancel',
              reasonLabel: 'Reason for taking offline',
              reasonPlaceholder:
                'Enter a reason. It will be visible in the merchant operation record.',
              channel: {
                offline: {
                  title: 'Take this channel offline?',
                  description:
                    'Models on “{{name}}” will immediately stop participating in routing.',
                  confirm: 'Take offline',
                },
                restore: {
                  title: 'Restore this channel?',
                  description:
                    'Approved and published models on “{{name}}” can participate in routing again.',
                  confirm: 'Restore channel',
                },
              },
              model: {
                offline: {
                  title: 'Unpublish this model?',
                  description: 'The “{{name}}” listing will immediately leave the routing pool.',
                  confirm: 'Unpublish model',
                },
                restore: {
                  title: 'Restore this model service?',
                  description:
                    'The “{{name}}” listing can participate again while its channel is available.',
                  confirm: 'Restore model',
                },
              },
            },
            tabs: {
              channels: 'Channels',
              models: 'Models',
              modelLogs: 'Model ledger',
            },
            sections: {
              channels: {
                title: 'Channels for {{merchant}}',
                description:
                  'View real channel configuration and runtime status for merchant ID {{id}}.',
              },
              models: {
                title: 'Models for {{merchant}}',
                description:
                  'View model listings, pricing, and review status for merchant ID {{id}}.',
              },
              modelLogs: {
                title: 'Model ledger for {{merchant}}',
                description:
                  'View model reviews, price changes, and lifecycle entries for merchant ID {{id}}.',
              },
            },
            publicId: 'Channel ID {{id}}',
            merchantLoading: 'Loading merchant details…',
            merchantLoadError:
              'This merchant could not be loaded. Return to the list and confirm it still exists.',
            loadError: 'This merchant data could not be loaded',
            retry: 'Try again',
            channels: {
              search: 'Search channel name, ID, or provider',
              caption: 'Channels owned by the selected merchant',
              empty: 'This merchant has no channels',
              loading: 'Loading merchant channels…',
              details: {
                action: 'Details',
                title: '{{name}} channel details',
                description:
                  'View the configuration, description, and latest action for channel ID {{id}}.',
                close: 'Close',
                ...
                latestOperation: 'Latest action',
                operationLoading: 'Loading the latest action…',
                operationError: 'The latest action could not be loaded',
                operationAction: 'Action',
                operator: 'Operator',
                operatorId: 'User ID {{id}}',
                operationReason: 'Action note',
                operationTime: 'Action time',
                noOperationReason: 'No note provided',
                noOperation: 'No activation or offline actions yet',
                actions: {
                  activate: 'Restore',
            ...
            models: {
              search: 'Search model name, ID, or channel',
              modelFilter: 'Select a model',
              allModels: 'All models',
              modelSearchPlaceholder: 'Search model name or ID',
              modelSearchEmpty: 'No matching models',
              channelFilter: 'Select a channel',
              allChannels: 'All channels',
              channelSearchPlaceholder: 'Search channel name, ID, or provider',
              channelSearchEmpty: 'No matching channels',
              billingModeFilter: 'Filter by billing mode',
              allBillingModes: 'All billing modes',
              reviewStatusFilter: 'Filter by review status',
              caption: 'Model listings owned by the selected merchant',
              empty: 'This merchant has no model listings',
              loading: 'Loading merchant models…',
              requestPrice: '{{price}} per request',
              tokenPrice: 'Input {{input}} · output {{output}}',
              details: {
                action: 'Details',
                title: '{{name}} model details',
                description:
                  'View listing configuration, review and routing status, and the latest action.',
                close: 'Close',
                ...
                price: 'Complete merchant pricing',
                currentPrice: 'Current merchant pricing',
                pendingPrice: 'Updated pricing',
                priceTooltip: '{{price}}; hover to view complete pricing',
                priceTooltipWithChange: '{{price}}; hover to view current and updated pricing',
                pendingPriceReview: 'Updated pricing is pending review',
                pendingPriceRejected: 'Updated pricing was rejected',
                pendingPriceEffective: 'Updated pricing takes effect on {{date}}',
                pricing: {
                  ...
                  groups: {
                    ...
                    base: 'Standard pricing',
                    baseUntil: 'Standard pricing (up to {{size}} tokens)',
                    contextOver200k: 'Over 200K context',
                    customTier: 'Context tier pricing',
                    contextTier: 'Over {{size}} tokens',
                    contextRange: 'Over {{minimum}} and up to {{maximum}} tokens',
                    tier: '{{type}} · over {{size}} tokens',
                ...
                operationTime: 'Action time',
                noOperationReason: 'No note provided',
                noOperation: 'No publish or unpublish actions yet',
                actions: {
                  activate: 'Restore listing',
                  offline: 'Unpublish model',
                  delete: 'Delete model',
                },
                operatorSources: {
                  admin: 'Administrator',
            ...
            modelLogs: {
              search: 'Search ledger ID, model, or details',
              operatorId: 'User ID {{id}}',
              operatorSources: {
                admin: 'Administrator',
                merchant: 'Merchant',
              ...
              statusFilter: 'Filter by ledger status',
              caption: 'Model business ledger for the selected merchant',
              empty: 'This merchant has no model ledger entries',
              emptyDescription:
                'Model reviews, price changes, and lifecycle actions create real entries here.',
              loading: 'Loading model ledger…',
              columns: {
                record: 'Model record',
                type: 'Type',
                status: 'Status',
                operator: 'Operator',
                description: 'Details or review note',
        ...
        merchant: {
          ...
          withdrawals: {
            ...
            loading: 'Loading withdrawal data…',
            loadError: 'Withdrawal data could not be loaded.',
            retry: 'Reload',
            stats: {
            ...
            form: {
              ...
              fee: '{{percent}}% withdrawal fee',
              method: 'Settlement method',
              account: 'Settlement account',
              destination: 'Destination account',
              noAccounts: 'Add a settlement account in your merchant profile first.',
            ...
            feedback: {
              submitted: 'Withdrawal submitted and reserved from your available balance.',
              invalid: 'Check the withdrawal amount and settlement account.',
              belowMinimum: 'The withdrawal amount must be at least {{minimum}}.',
              insufficientBalance: 'Insufficient available balance. Reload and try again.',
              accountNotFound: 'That settlement account no longer exists.',
              submitError: 'The withdrawal could not be submitted. Try again later.',
            },
          },
          requests: {
